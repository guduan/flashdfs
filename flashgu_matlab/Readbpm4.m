function orbit=Readbpm4(energy)
...
switch energy
    case 600
        orbit=textread([elegant_file_root 'flash_dfs31.orbit'],'%*n %*s %n' );
    case 720
        orbit=textread([elegant_file_root 'flash_dfs32.orbit'],'%*n %*s %n' );
    case 900
        orbit=textread([elegant_file_root 'flash_dfs33.orbit'],'%*n %*s %n' );
    otherwise
