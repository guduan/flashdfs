...
%    C: SVD threshold(阈值), optional (defaults to 0, i.e. use all). Positive
%       number interpreted as fractional threshold, negative value as # to use

% Output arguments:
%    X:    Fitted parameters
%    STDX: Estimated standard errors of fitted parameters
%    MSE:  Mean squared error,均方误差 based on singular values used after
%          threshold applied
%    S:    Estimated covariance matrix 协方差矩阵 of fitted parameters
