function beamline = getline_noacc(region)
%=======================
...
L3pha=17 ; 
L3volt=54.7835 ; 
BC1ang=3.907/180*pi; %RPN 逆波兰表示法
BC1L12=5 ; 
BC1L12r=1.120 ; 
BC2ang=2.188/180*pi; 
BC2L12=5 ; 
...
%L0SHIFT= RFCA, FREQ=2.856000000E+09, L=1.0E-6, 
%         VOLT=2e7, PHASE="180 90 +", 
%         CHANGE_P0=1, END1_FOCUS=0, END2_FOCUS=0

%L0WAKE= WAKE, INPUTFILE="sband_L_10mm.sdds", factor="86 2 *", 
%        tColumn="t", wColumn="W", N_BINS=0, SMOOTHING=1, 
%interpolate=1
...
% CbandF = 5712;
% %sband=18MV/m, 2pi/3
% AS1o10L1= {'lc' 'AS1o10L1' 2.974132/10 [SbandF L1volt/2.974132*2.974132/10 (L1pha)*pi/180]}';
% 
% %xband=24.4MV/m, 5pi/6
% AX1o1L1= {'lc' 'AX1o1L1' 0.590453/1 [XbandF L1volt/0.590453*0.590453/1 (Lxpha)*pi/180]}';
% 
% %sband=18MV/m, 2pi/3
% AS1o5L2_1= {'lc' 'AS1o5L2_1' 2.974132/5 [SbandF L2volt/2.974132*2.974132/5 (L2pha)*pi/180]}';
% AS1o5L2_2= {'lc' 'AS1o5L2_2' 2.974132/5 [SbandF L2volt/2.974132*2.974132/5 (L2pha)*pi/180]}';
% 
% %cband=30.5MV/m, 4pi/5
% AC1o6L3_1= {'lc' 'AC1o6L3_1' 1.763485/6 [CbandF L3volt/1.763485*1.763485/6 (L3pha)*pi/180]}';
% AC1o6L3_2= {'lc' 'AC1o6L3_2' 1.763485/6 [CbandF L3volt/1.763485*1.763485/6 (L3pha)*pi/180]}';
% AC1o6L3_3= {'lc' 'AC1o6L3_3' 1.763485/6 [CbandF L3volt/1.763485*1.763485/6 (L3pha)*pi/180]}';
% AC1o6L3_4= {'lc' 'AC1o6L3_4' 1.763485/6 [CbandF L3volt/1.763485*1.763485/6 (L3pha)*pi/180]}';
% %cband=0MV/m, 4pi/5
% AC1o6L3_5= {'lc' 'AC1o6L3_5' 1.763485/6 [CbandF L3volt*0/1.763485*1.763485/6 (L3pha)*pi/180]}';%0Mev ???
%======================================================================
% Bend
% ('be')
%======================================================================
B1BC1= {'be' 'B1BC1' 0.2*BC1ang/sin(BC1ang) [BC1ang 1.500000000e-02 0.000000000e+00 BC1ang 0.5 0.5 0]}';
B2BC1= {'be' 'B2BC1' 0.2*BC1ang/sin(BC1ang) [BC1ang 1.500000000e-02 -BC1ang 0.000000000e+00  0.5 0.5 0]}';
B3BC1= {'be' 'B3BC1' 0.2*BC1ang/sin(BC1ang) [BC1ang 1.500000000e-02 0.000000000e+00 -BC1ang 0.5 0.5 0]}';
B4BC1= {'be' 'B3BC1' 0.2*BC1ang/sin(BC1ang) [BC1ang 1.500000000e-02 BC1ang 0.000000000e+00 0.5 0.5 0]}';

B1BC2= {'be' 'B1BC1' 0.2*BC2ang/sin(BC2ang) [BC2ang 1.500000000e-02 0.000000000e+00 BC2ang 0.5 0.5 0]}';
B2BC2= {'be' 'B2BC1' 0.2*BC2ang/sin(BC2ang) [BC2ang 1.500000000e-02 -BC2ang 0.000000000e+00  0.5 0.5 0]}';
B3BC2= {'be' 'B3BC1' 0.2*BC2ang/sin(BC2ang) [BC2ang 1.500000000e-02 0.000000000e+00 -BC2ang 0.5 0.5 0]}';
B4BC2= {'be' 'B3BC1' 0.2*BC2ang/sin(BC2ang) [BC2ang 1.500000000e-02 BC2ang 0.000000000e+00 0.5 0.5 0]}';
%======================================================================
% Corrector
% ('cr')
%======================================================================
...
% ('qu')
%======================================================================
Q01L1= {'qu' 'Q01L1' 0.1 -8.9371070862}';
Q02L1= {'qu' 'Q02L1' 0.2 8.7126064301}';
Q03L1= {'qu' 'Q03L1' 0.1 -8.9371070862}';
Q01BC1= {'qu' 'Q01BC1' 0.2 -5.4073843956}';
Q02BC1= {'qu' 'Q02BC1' 0.2, 4.9422450066}';
...
Q01BI1= {'qu' 'Q01BI1' 0.2, -4.7189273834}';
Q02BI1= {'qu' 'Q02BI1' 0.2, 4.8606848717}';
Q03BI1= {'qu' 'Q03BI1' 0.2, 5.4985251427}';
Q04BI1= {'qu' 'Q04BI1' 0.2, -8.3574256897}';
...
Q01L2H= {'qu' 'Q01L2H' 0.1, -0.7855048180}';
Q01BC2= {'qu' 'Q01BC2' 0.2, -2.0940432549}';
Q02BC2= {'qu' 'Q02BC2' 0.2, 2.3666968346}';
Q03BC2= {'qu' 'Q03BC2' 0.1, 0}';
Q04BC2= {'qu' 'Q04BC2' 0.1, 0}'; %TILT="pi 4 /"
Q05BC2= {'qu' 'Q05BC2' 0.1, 0}';
Q01BI2= {'qu' 'Q01BI2' 0.2, -1.9167764187}';
Q02BI2= {'qu' 'Q02BI2' 0.2, 1.7845157385}';
Q03BI2= {'qu' 'Q03BI2' 0.2, 1.5826873779}';
Q01L3H= {'qu' 'Q01L3H' 0.1, -1.8846712112}';
...
%cenbc1= center, x=1, xp=1, y=1, yp=1
%cenbc2= center, x=1, xp=1, y=1, yp=1

%w0= watch, filename="L0.out", mode=coord
%w1= watch, filename="L1.out", mode=coord
%w2= watch, filename="BC1.out", mode=coord
%w3= watch, filename="L2.out", mode=coord
%w4= watch, filename="BC2.out", mode=coord
%w5= watch, filename="L3.out", mode=coord
...
ASL1=[DAWGS,DAWGS];
AXL1=[DAWGX1,DAWGX2];
L1=[DZERO,DZERO,D01L1,Q01L1,D02L1,Q02L1,D03L1,Q03L1,D04L1,BLL01,...
   BPM01,CRR01,D05L1,PRF01,VALV,BLL02,ASL1,BLL03,ASL1,BLL02,VALV,...
   BLL01,AXL1,BLL01,VALV,PSTN01];
%======================================================================
% BC1
%
%======================================================================		  
...
BC1=[DZERO,D01BC1,...
    Q01BC1,D02BC1,Q02BC1,D03BC1,BLL01,BPM02,...
...
%
%======================================================================
ACL3_1=[DAWGC1, DAWGC2];
ACL3_2=[DAWGC1, DAWGC2];
ACL3_3=[DAWGC1, DAWGC2];
ACL3_4=[DAWGC1, DAWGC2];
ACL3_5=[DAWGC1, DAWGC2];
...
H05L3=[DZERO, D13L3, Q05L3H, PSTN14, Q05L3H, D14L3, ...
             ...
             ACL3_5, BLL04, ACL3_5, BLL01, VALV];
...
%
%======================================================================
lineAll=[L1,BC1,BI1,L2,BC2,BI2,L3,BI3];
testline=[L1,BC1,BI1,L2,BC2,BI2,L3];
switch region
	case 'linac'
	beamline = lineAll;
	case 'L1'
