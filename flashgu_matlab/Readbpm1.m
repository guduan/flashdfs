...
switch energy
    case 600
        orbit=textread([elegant_file_root 'flash_dfs1.orbit'],'%*n %*s %n' );
    case 720
        orbit=textread([elegant_file_root 'flash_dfs2.orbit'],'%*n %*s %n' );
    case 900
        orbit=textread([elegant_file_root 'flash_dfs3.orbit'],'%*n %*s %n' );
    otherwise
