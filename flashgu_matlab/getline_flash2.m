function BEAMLINE= getline_flash2(Kfactor)
%=======================
...
% %disable former defination of UNDU*, change according to MAD File.22:47 2013-2-19 by duan
...
B01SMT=[BPM1SMATCH, BPM1SMATCHi, D0077, ...
...
% VOGTM : 11.03.2010 : INSERT IN--UNDULATOR BPMS IN APPROX RIGHT POSITIONS
%
% SPLIT UNDULATORS >>>>
%
...
UNDULATOR1= [StartUND, UNDU1, UNDU2, UNDU3, UNDU4, UNDU5, UNDU6, EndUND];
...
BEAMLINE=[MALIN,B01SMT,UNDULATOR1, EXP];