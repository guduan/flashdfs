...
UNDU61=[ U6BEG, UND_PART1, BPM2UND6, UND_PART2, BPM4UND6, UND_PART3, ...
    U6END, Q5UND6000, WIRE5UND600, BPM5UND6];
%change UNDU6 -- UNDU61 just delete Q6UND6000. 9:40 2013-2-28 by duan

StartUND=  {'dr' '' 0 []}';
EndUND=  {'dr' '' 0 []}';

UNDULATOR= [StartUND, UNDU1, UNDU2, UNDU3, UNDU4, UNDU5, UNDU6, EndUND];
UNDULATOR1= [StartUND, UNDU1, UNDU2, UNDU3, UNDU4, UNDU5, UNDU61, EndUND];
%=====================================================================================
%  EXP section
%=====================================================================================
...
my=[D0010, D0146, D0072,D0071, D0100, D0053, D0100g, ...
    Q14SMATCH, BPM14SMATCH, D0076g, WIRE14SMATCH00, ...
    D0076g, Q15SMATCH, D0026g, EndSMATCH];
%!-------------------------------------------------------------------------------------
...
% BEAMLINE=[MALIN,B01SMT,UNDULATOR];
BEAMLINE=[MALIN,UNDULATOR, EXP];